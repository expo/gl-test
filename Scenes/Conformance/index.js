...
const tests = (() => {
  ...
  $([
    ...
    _(
      require('@exponent/gl-conformance/node-test/programs_use-program-crash-with-discard-in-fragment-shader')
    ),
  ]);
  ...
  $([
    _(
      require('@exponent/gl-conformance/node-test/reading_read-pixels-pack-alignment'),
      [
    ...
    _(
      require('@exponent/gl-conformance/node-test/reading_read-pixels-test'),
      [
        // No error checking
        114,
        115,
  ...
  $([
    _(
      require('@exponent/gl-conformance/node-test/textures_copy-tex-image-2d-formats'),
      [
    ...
    _(
      require('@exponent/gl-conformance/node-test/textures_copy-tex-image-and-sub-image-2d'),
      [],
      2,
      2
    ),
